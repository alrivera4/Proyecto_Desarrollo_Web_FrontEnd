...
import AccountSettings from 'src/pages/account-settings/index'
    ...
    <>
      ...
      <Grid container style={styles.header}>
        <Grid item xs={12} sm={4} style={{ textAlign: 'center', marginTop: '1px' }}>
          <img src='/images/cards/image.png' alt='Logo' style={{ width: '200px', height: 'auto' }} />
        </Grid>
        <Grid item xs={12} sm={8} style={{ padding: '5px' }}></Grid>
      </Grid>

      <Grid container style={styles.heroContainer}>
        <Grid item spacing={5} xs={12} sm={4} mt={15} ml={10} style={styles.whiteText}>
