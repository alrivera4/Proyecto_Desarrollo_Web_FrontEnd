...
const rows = [
  createData('¿Es usted sustituto de persona con discapacidad severa 75%?', 159, 6.0, 24, 4.0, 3.99),
 
];

const TableCollapsible2 = () => {
  return (
      ...
      <Table aria-label='collapsible table'>
        <TableHead>
          <TableRow>
            ...
            <TableCell>Familiar sustituto</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map(row => (
...
export default TableCollapsible2;