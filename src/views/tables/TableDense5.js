...
import FormLayoutsPubArticulos from '../form-layouts/FormLayoutPubArticulos';
        ...
        <Table sx={{ minWidth: 1000 }} size='' aria-label='a dense table'>
          <TableHead>
            <TableRow>
              ...
              <TableCell align='right'>Base de Datos</TableCell>
