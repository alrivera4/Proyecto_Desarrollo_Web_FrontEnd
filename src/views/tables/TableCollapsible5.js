...
const rows = [
  createData('¿Fue ussted declarado Héroe o Heroínaa(nacional)?', 159, 6.0, 24, 4.0, 3.99),
 
];

const TableCollapsible5 = () => {
  return (
      ...
      <Table aria-label='collapsible table'>
        <TableHead>
          <TableRow>
            ...
            <TableCell>Heroe/Heroina</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map(row => (
...
export default TableCollapsible5;